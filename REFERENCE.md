...
**Published:** November 4, 2025 | **Source:** [Anthropic Engineering](https://www.anthropic.com/engineering) | **Original Post:** [https://www.anthropic.com/engineering/code-execution-with-mcp](https://www.anthropic.com/engineering/code-execution-with-mcp)
...
Most MCP clients allow models to directly call MCP tools. For example, you might ask your agent: _"Download my meeting transcript from Google Drive and attach it to the Salesforce lead."_
...
> **How it works:** The MCP client loads tool definitions into the model's context window and orchestrates a message loop where each tool call and result passes through the model between operations.
